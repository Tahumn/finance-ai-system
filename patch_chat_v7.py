...
s_marker = "def answer_chat_REPLACED_TEST("
if s_marker not in source:
    s_marker = "def answer_chat("

s = source.find(s_marker)
e = source.find("def _otsu_threshold(")

if s == -1 or e == -1:
    print(f"Markers not found {s} {e}")
    exit(1)
