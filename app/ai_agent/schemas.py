...
class OcrResponse(BaseModel):
    ...
    @property
    def merchant(self) -> str | None: return self.data.merchant
    @property
    def total(self) -> float | None: return self.data.final_total
    @property
    def date(self) -> DateType | None: return self.data.transaction_date
    @property
    def vat(self) -> float | None: return self.data.vat_amount
    @property
    def estimated(self) -> float | None: return self.data.subtotal_before_tax
    @property
    def note(self) -> str | None: return self.data.suggested_note
    @property
    def text(self) -> str: return self.data.raw_ocr_text
